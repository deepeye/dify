const translation = {
  ...
  members: {
    ...
    invitationSentTip: '邀请已发送，对方登录 Deepeye 后即可访问你的团队数据。',
    invitationLink: '邀请链接',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: '体验',
      exhausted: '超出限额',
      desc: '托管 OpenAI 由 Deepeye 提供的托管 OpenAI 服务，你可以使用 GPT-3.5 等模型，在体验额度消耗完毕前你需要设置其它模型供应商。',
      callTimes: '调用次数',
  ...
  about: {
    changeLog: '更新日志',
    updateNow: '现在更新',
    nowAvailable: 'Deepeye {{version}} 现已可用。',
    latestAvailable: 'Deepeye {{version}} 已是最新版本。',
  },
  appMenus: {
    overview: '概览',
    promptEng: '编排',
